...
R code for 'Netzel et al. (2023): New methods for quantitative climate reconstructions applied to extended data from Lake Kinneret in Israel, Clim. Past Disc.'
...
Contact timon.netzel@uni-bonn.de for reporting of bugs, questions, code for additional functionality, and additional dataset
