...
List mcmc_execution(
    ...
    // core data
    rec.length_age = core_info["length_age"]; 
    const int num_taxa = core_info["num_taxa"]; 
    tf.num_biomes = core_info["num_biomes"]; 
    ...
    const int dirichlet_spread = proposal_params["dirichlet_spread"];
    ...
    const int sample_length = sampling_info["sample_length"];
